 ...
 * @author madis
 */
@WebServlet(name="SendHello", urlPatterns={"/SendHello"})
public class SendHello extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SendHello</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SendHello at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
